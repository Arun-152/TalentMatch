...
class TalentMatchAPITests(APITestCase):
    ...
    def test_analysis_endpoints(self):
        # Create dependencies
        resume = Resume.objects.create(raw_text='Python')
        ...
        # Test POST fail (invalid resume)
        bad_data = {'resume': '00000000-0000-0000-0000-000000000000', 'job_description': str(job.id)}
        ...
        # Should contain pagination 'results' based on drf configuration
        self.assertTrue('results' in list_response.data)
